...
Sectors can contain specific byte patterns which can be analyzed and used to identify the type of content stored in the sector. 
...
\label{chtr:sector-content-visualization}
...
The provided buffer's Shannon entropy can be calculated using the formula mentioned in the subsubsection \ref{sss:entropy}.
...
Image generated with Shannon's entropy can be found in the figure FIGURE.   % TODO
...
\begin{figure}
    \centering
    \includegraphics[width=.95\textwidth,interpolate=false]{figures/test-ext4-no-trim-chi2-4-sweeping-zoomed.png}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth,interpolate=false]{figures/ubnt-test-aes-128-ecb-chi2-4-hilbert-legend.png}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/win-unencrypted-chi2-4-hilbert.png}
    \caption{Unencrypted}
  ...
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/win-encrypted-chi2-42.png}
    \caption{Encrypted using BitLocker}
    \label{fig:bitlocker-enc}
  \end{subfigure}
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/fve4.png}
    \caption{Visualization of FVE metadata at the offset of 0xc9c93800 bytes}
  ...
  \end{subfigure}
  \caption{Windows 10 disk image before and after encryption with BitLocker and FVE metadata}
  \label{fig:bitlocker}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/ext4-luks2-sweeping.png}
    \caption{Generated image from the entire 2GiB image}
    \label{fig:luks-unenc}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/ext4-luks2-head.png}
...
A VeraCrypt file-hosted volume of size 1GiB was created in a Ubuntu installation in Oracle VM VirtualBox with ext4 filesystem and without TRIM.
The images in figure \ref{fig:veracrypt} were generated from the converted raw images before and after the VeraCrypt file-hosted volume creation.

In the figure \ref{fig:veracrypt-with} is noticeably more sectors marked as random than in the figure \ref{fig:veracrypt-without}.
...
This could be explained by the fact that some of the displaced sectors classified as not random could be remnants of previously deleted data, which has not been trimmed because of the disabled discard and were therefore not zeroed.

\begin{figure}
  \centering
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/ubnt-unencrypted-chi2-4-sweeping-blocks.png}
    \caption{Without VeraCrypt volume}
    \label{fig:veracrypt-without}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=\textwidth,interpolate=false]{figures/ubnt-veracrypt-chi2-4-sweeping-blocks.png}
    \caption{LUKS2 header generated with 8x8 sweeping blocks method}

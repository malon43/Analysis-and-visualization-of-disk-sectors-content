...
\begin{figure}
  \begin{center}
    ...
    %   \begin{tikzpicture}[point/.style={circle,fill=blue!90,minimum size=4pt,inner sep=0pt}]
    %     \node[point](0){};
    %     \node[point](1)  [right of = 0]  {};
    %     \node[point](2)  [right of = 1]  {};
    %     \node[point](3)  [right of = 2]  {};
    ...
    \end{minipage}
  \end{center}
\caption{Orders from left: sweeping, 2x2 block sweeping, and 4x4 block sweeping}
  \label{fig:visorders}
\end{figure}
\begin{figure}
  \begin{center}
    ...
    \end{minipage}
  \end{center}
  \caption{One, two, and three iterations of the Hilbert curve}

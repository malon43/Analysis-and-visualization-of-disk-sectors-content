...
\begin{figure}
    \centering
    \includegraphics[width=.6\textwidth]{ubnt-unencrypted-shannon-hilbert-asalor.png}
    \caption{Image from figure \ref{fig:veracrypt-without} generated with Shannon's entropy analysis}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{.45\textwidth}
    ...
    \caption{After creating 1GiB VeraCrypt volume}
  ...
  \end{subfigure}
  \caption{Difference before and after creating VeraCrypt file-hosted volume generated by the  \texttt{sweeping-blocks} method}
  \label{fig:veracrypt}
\end{figure}

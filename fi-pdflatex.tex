...
...description of the chapter... % TODO
...
\section{Analysis}
...describe section and the fact that it is a class... % TODO
...
The fact that the Counter object only iterates over nonzero counts does not matter.
...
Image generated with Shannon's entropy can be found HERE.   % TODO

\subsection{Chi-square}

The implementation includes multiple options for analyzing by chi-square test.
Each option takes $n$ consecutive bits and treats it as a separate number.

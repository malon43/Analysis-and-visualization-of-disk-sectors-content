...
This visualization can also be used as an illustration while teaching.

The text of this thesis is structured into four chapters.
Chapter number one lists some byte patterns of sectors and discusses algorithms for their detection.
Chapter number two discusses algorithms used to calculate entropy and possible issues with their accuracy.
Chapter number three discusses ways of visualization and their advantages and disadvantages.
...
\chapter{Specific sector patterns and their detection}

...
\begin{figure}
  ...
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=.5\textwidth,interpolate=false]{figures/win-unencrypted-chi2-4-photocopy-safe2.png}
    \caption{Unencrypted}
    \label{fig:idk-unenc}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[width=.5\textwidth,interpolate=false]{figures/win-encrypted-chi2-42.png}

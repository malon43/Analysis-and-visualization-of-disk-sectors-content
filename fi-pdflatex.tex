...
This chapter focuses on possible byte patterns which can be found in the disk sectors, their uses, ways of detection, and the usefulness of their visualization.
\section{Single byte patterns}

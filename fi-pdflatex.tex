...
\begin{figure}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/pv204_fde-chi2-4-sweeping.png}
        \caption{Sweeping}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/pv204_fde-chi2-4-sweeping-blocks.png}
    ...
    \begin{subfigure}[t]{.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/pv204_fde-chi2-4-hilbert.png}
...
\begin{figure}[H]
  \includegraphics[width=.45\textwidth]{figures/legend.png}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/test-ext4-no-trim-chi2-4-sweeping.png}
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/test-ext4-chi2-4-sweeping.png}
    \caption{Encrypted ext4 with TRIM}
    \label{fig:trim-ext4-trim}
  \end{subfigure}
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/test-xfs-no-trim-chi2-4-sweeping.png}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/test-xfs-chi2-4-sweeping.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{figures/test-ext4-no-trim-chi2-4-sweeping-zoomed.png}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/ubnt-unencrypted-test-chi2-4-hilbert.png}
        \caption{Unencrypted}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/ubnt-test-aes-128-ecb-chi2-4-hilbert.png}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{.45\textwidth}
    \centering
    \includegraphics[widht=\textwidth]{figures/idk.png}

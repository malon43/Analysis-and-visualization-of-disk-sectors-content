...
\thesissetup{
    ...
    abstract    = {%
      ...
      This thesis discusses methods of classifying disk sectors based on their randomness using statistical tests or Shannon's entropy calculation and methods of visualization.

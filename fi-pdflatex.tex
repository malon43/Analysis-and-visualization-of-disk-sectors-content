...
\thesissetup{
    ...
    title       = {Analysis and visualization of disk sectors content},
    TeXtitle    = {Analysis and visualization of disk sectors content},
...
\chapter{Disk structure and specific patterns}
